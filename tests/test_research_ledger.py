from src.research_ledger import compact, LANES

def test_compact_is_small_and_does_not_copy_internal_blobs():
    out=compact({"status":"OK","research_only":True,"production_changed":False,"final_holdout_protected":True,"summary":{"mean_logloss_delta":-0.01},"final_holdout":{"n":100},"huge_internal_blob":"secret"})
