...
class AdaptiveEnsembleHoldoutTests(unittest.TestCase):
    def test_development_selection_and_holdout_are_separate(self):
        ...
        with patch.object(adaptive, "load_rows", return_value=rows):
            with patch.object(adaptive, "_evaluate_development", return_value=({"blocks": 8, "stable_blocks": 8, "stable_improved_logloss_ratio": 0.75, "stable_improved_brier_ratio": 0.75, "stable_mean_logloss_delta": -0.01, "stable_mean_brier_delta": -0.01}, [], True, True, [])):
