...
class PromotionGateTests(unittest.TestCase):
    ...
    def _cal(self):
        return {
            ...
            "10m": {"horizon": "10m", "temperature": 1.0, "model_version": "v10"},
        }
    ...
    def _accepted_blends(self):
        return {
            "5m": {
                ...
                "candidate_logloss": 0.49,
                "baseline_brier": 0.30,
                "candidate_brier": 0.29,
            },
            "10m": {
                "status": "accepted",
                "holdout_protected": True,
                "holdout_used_for_selection": False,
                "holdout_n": 100,
                "baseline_logloss": 0.55,
                "candidate_logloss": 0.54,
                "baseline_brier": 0.32,
                "candidate_brier": 0.31,
            },
        }
